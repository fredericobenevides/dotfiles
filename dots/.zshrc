...
plugins=(brew bundler docker docker-compose flutter gem git kubectl node npm oc pip postgres python fredericobenevides myutils)
...
# flatpak alias
alias android_studio="flatpak run com.google.AndroidStudio"
...
if [[ -d '/opt/flutter' ]]; then
  ...
  export FLUTTER_PUB_CACHE="$HOME/.flutter/.pub-cache"
  export DART_HOME="$HOME/.flutter/bin/cache/dart-sdk"
